...
**[Live mockup →](https://spendry.github.io/repost/)** *(interactive front-end mockup; best on a phone-width window)*

If the live link is not up yet, open [`index.html`](index.html) locally in any browser.

## What's here

| File | What it is |
|---|---|
| [index.html](index.html) | The interactive front-end mockup: the decay loop, the ember bar, vitals, and branch mechanics, all visible in motion. |
